[[Kontraposition Pumping Lemma]], [[Pumping Lemma für Kontextfreie Sprachen]]

- Jede [[Reguläre Sprache]] $L$ wird von einem [[Endlicher Automat|endlichen Automaten]] erkannt
- Wenn $L$ beliebig lange Wörter enthält (= unendliche Sprache), muss $A_{L}$ einen [[Zyklus]] enthalten
