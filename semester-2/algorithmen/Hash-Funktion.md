...
1.  [[Kollision]]-Resistenz: Ein [[Tupel]] $(x, y)$ zu finden sodass $h(x) = h(y)$ sollte so schwer wie möglich sein
...
> [!info] Muss auch einfach zu berechnen sein!! -> [[lineare Laufzeit]] ideally
