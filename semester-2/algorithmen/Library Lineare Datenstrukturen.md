...
- jeder neue [[Knoten]] (= Element) einer [[Liste]] kann irgendwo in den Speicher geworfen werden, wo grade Platz ist - jeder [[Knoten]] kennt entweder 1. seinen Nachfolger --> [[Singly Linked List]] 2. seinen Nachfolger _und_ Vorgänger --> [[Doubly Linked List]] - Dadurch ist Länge der [[Liste]] höchst dynamisch, und [[Payload]] der [[Knoten]] kann von verschiedenen Datentypen sein (-> [[Heterogene Liste]])
