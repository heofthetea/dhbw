...
Sei $f: \mathbb{N} \longrightarrow \mathbb{N}$ eine [[Abbildung|Funktion]]. Eine [[Turing Machine]] $M$ mit dem [[Alphabet]] $\Sigma$ heißt **$f$-zeitbeschränkt**, wenn für jede Eingabe $w \in \Sigma^{*}$ jede [[Berechnung]] von $M$ höchstens $f(|w|)$ Schritte hat.
