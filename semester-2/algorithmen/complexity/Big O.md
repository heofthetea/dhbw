...
Für eine [[Abbildung|Funktion]] $f$ bezeichnet $O(f)$ die [[Menge]] aller Funktionen $g$ mit:
...
> [!hint] Definition
> $O(f)$ ist die Menge allerr [[Abbildung|Funktionen]], die _langfristig_ nicht _wesentlich schneller_ wachsen als $f$
