## quick shot at a formal definition
An [[Object]] is [[Tupel]] defined by two sets: the [[Menge|set]] of its [[Attribut|Attributes]] $A$, and the set of its [[Methode|methods]] $M$.
$$O = ({A}, {M})$$
...
The [[Schema einer Relation|scheme]] $(A, M)$ is defined by the object's [[Class]], where the only thing differing among [[Object|objects]] of the same [[Class]] is the set of their values $v$.
